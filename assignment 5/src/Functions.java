...
public class Functions {
	...
	//-----------------------------------------------------------------
	//	Loops through the account list and returns the highest key value
	//-----------------------------------------------------------------
	public long latestAccountNr(HashMap<Long, Account> accountList) {
		long latestAccountNr = 0;
		for (Long key : accountList.keySet()) {
		   if(latestAccountNr < key){
			   latestAccountNr = key;
		   }
		}
		return latestAccountNr;
	}
